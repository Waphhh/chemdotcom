...
function closePopUp() {
    ...
    if (document.getElementById("popUpBold").innerHTML == "Welcome") {
        ...
        document.getElementById("photosynthesiseqn").innerHTML = "Photosynthesis chemical formula: 6CO<sub>2</sub> (Carbon dioxide) + 6H<sub>2</sub>O (Water) + light energy (From the sun) → C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> (Glucose) + 6O<sub>2</sub> (Oxygen)";
    } else {
        console.log("check 2")
    }
}
